...
import com.csc.mobile.entity.GesturePoint;
import com.csc.mobile.utils.AppUtil;
...
public class GestureDrawline extends View {
    ...
    public interface GestureCallBack {
         ...
         * 代表用户绘制的密码与传入的密码不相同
         */
        public abstract void checkedFail(String inputCode);
    }
}
